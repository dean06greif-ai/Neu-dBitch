...
def _purge_paper_trades():
    """Eigene Alt-Trades entfernen, damit Anti-Stacking den Test nicht blockt."""
    try:
        from pymongo import MongoClient
        db = MongoClient(os.environ.get("MONGO_URL", "mongodb://localhost:27017"))[
            os.environ.get("DB_NAME", "crypto_scanner")]
        db.auto_trades.delete_many({"mode": "paper", "symbol": "BTCUSDT"})
        db.settings.update_one({"_id": "trade_guard_state"},
