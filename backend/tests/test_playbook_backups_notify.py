...
def _clear_provider_env(monkeypatch, base: str):
    """Echte Umgebungs-Keys (BACKUP4..13 etc.) ausblenden – Test bleibt isoliert."""
...
def test_multiple_backup_keys_order(monkeypatch):
    _clear_provider_env(monkeypatch, "CEREBRAS_API_KEY")
...
def test_backup_key_counts(monkeypatch):
    _clear_provider_env(monkeypatch, "OPENROUTER_API_KEY")
